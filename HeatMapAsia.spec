...
a = Analysis(
    ...
    hiddenimports=['webview', 'webview.platforms.edgechromium', 'clr', 'pythonnet', 'fastapi', 'uvicorn', 'uvicorn.loops.auto', 'uvicorn.protocols.http.auto', 'sqlalchemy', 'yt_dlp', 'tubescrape', 'nicovideo_api_client', 'config_paths', 'version', 'web.update', 'scraper.runner', 'scraper.youtube', 'scraper.niconico', 'scraper.scorer', 'scraper.dedup', 'scraper.channels', 'scraper.regions', 'scraper.official', 'scraper.utils', 'scraper.config'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
